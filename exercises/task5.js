...
if ((a < 0 && b >= 0 && c >= 0) || (b < 0 && a >= 0 && c >= 0) || (c < 0 && a >= 0 && b >= 0)) {
    console.log('Berilgan sonlar orasida 1 ta manfiy son bor');
} else if ((a < 0 && b < 0 && c >= 0) || (b < 0 && a >= 0 && c < 0) || (c < 0 && a < 0 && b >= 0)) {
    console.log('Berilgan sonlar orasida 2 ta manfiy son bor');
} else if (a < 0 && b < 0 && c < 0) {
    console.log('Berilgan sonlar orasida 3 ta manfiy son bor');
} else {
    console.log("Berilgan sonlar orasida manfiy son yo'q");
}